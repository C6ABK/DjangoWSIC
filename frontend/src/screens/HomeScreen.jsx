        ...
        <Container>
            <div className="space-y-16 mt-10">
                ...
                <Card title="Adam Bark's Django-React Template">
                    <p>
                        Django React template with authentication. Run pip install -r manual-requirement.txt in the backend folder and npm install in the frontend folder to begin.
                    </p>
