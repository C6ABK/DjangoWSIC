...
class MGProduct(models.Model):
    ...
    dividerLevelSetPoint = models.IntegerField(null=False, blank=False)
    ...
    marshallingScrap = models.IntegerField(null=False, blank=False)
    machineScrap = models.IntegerField(null=False, blank=False)
    productionScrap = models.IntegerField(null=False, blank=False)
    ...
    SAPEfficiency = models.DecimalField(max_digits=6, decimal_places=2, null=True, blank=True)
    SAPYield = models.DecimalField(max_digits=6, decimal_places=2, null=True, blank=True)
    scalingWeight = models.IntegerField(null=False, blank=False)
